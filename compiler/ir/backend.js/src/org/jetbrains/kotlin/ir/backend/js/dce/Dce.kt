...
fun eliminateDeadDeclarations(
    ...
    val usefulDeclarations = JsUsefulDeclarationProcessor(context, printReachabilityInfo)
        .collectDeclarations(allRoots, context.additionalExportedDeclarations, removeUnusedAssociatedObjects)
