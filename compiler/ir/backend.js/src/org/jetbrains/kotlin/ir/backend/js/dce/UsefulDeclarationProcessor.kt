...
abstract class UsefulDeclarationProcessor(private val printReachabilityInfo: Boolean) {
    ...
    protected val referencedJsClasses = hashSetOf<IrDeclaration>()
    protected val referencedJsClassesFromExpressions = hashSetOf<IrClass>()
    private val classesWithObjectAssociations = hashSetOf<IrClass>()
